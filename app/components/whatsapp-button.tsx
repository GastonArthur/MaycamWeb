  ...
  return (
    ...
    >
      <div className="relative">
        ...
        {isHovered && (
          <span className="absolute right-full mr-2 top-1/2 transform -translate-y-1/2 whitespace-nowrap bg-gray-900 text-white text-sm py-1 px-2 rounded shadow-lg">
            Chatea con nosotros
          </span>
        )}
      </div>
